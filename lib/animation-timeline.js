    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_renderGroupBounds", function (rowViewModel) {
      ...
      rowViewModel === null || rowViewModel === void 0 ? void 0 : (_rowViewModel$groupsV2 = rowViewModel.groupsViewModels) === null || _rowViewModel$groupsV2 === void 0 ? void 0 : _rowViewModel$groupsV2.forEach(function (groupsViewModels) {
        ...
        if (rectBounds !== null && rectBounds !== void 0 && rectBounds.rect) {
          var _groupsViewModels$gro, _groupsViewModels$gro2;
          _this._ctx.fillStyle = keyframeLaneColor;
          var rect = rectBounds.rect;
          var backgroundImage = groupsViewModels === null || groupsViewModels === void 0 ? void 0 : (_groupsViewModels$gro = groupsViewModels.groupModel) === null || _groupsViewModels$gro === void 0 ? void 0 : (_groupsViewModels$gro2 = _groupsViewModels$gro.style) === null || _groupsViewModels$gro2 === void 0 ? void 0 : _groupsViewModels$gro2.backgroundImage;
          if (!backgroundImage) {
            _this._ctx.fillRect(rect.x, rect.y, rect.width, rect.height);
            return;
          }
          ...
          backgroundImage.forEach(function (image) {
            ...
            var width = Math.min(height / ratio, remainingWidth);
            ctx.drawImage(image, x, rect.y, width, height);
            x += width;
            remainingWidth -= width;
          });
          if (remainingWidth > 0) {
            var lastImage = backgroundImage.at(-1);
            if (!lastImage) return;
            var ratio = lastImage.naturalWidth / lastImage.naturalHeight;
            var height = rect.height;
            var imageWidth = height / ratio;
            while (remainingWidth > 0) {
              var width = Math.min(imageWidth, remainingWidth);
